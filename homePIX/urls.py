...
urlpatterns = [
    ...
    re_path( r'^albums/(?P<album_id>\d+)/delete/(?P<pic_id>\d+)/$',          views.delete_id_from_album,          name = 'delete_id_from_album' ),
    re_path( r'^albums/(?P<album_id>\d+)/move/(?P<pic_id>\d+)/(?P<index>[+-]*\d+)/$', views.move_id_in_album,     name = 'delete_id_from_album' ),
